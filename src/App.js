...
class App extends Component {
  ...
  addGame(game) {
    ...
    players[winnerIndex] = { name: winningPlayer.name, won: winningPlayer.won + 1, lost: winningPlayer.lost};
    const loserIndex = players.findIndex(function(c) { 
      return c.name === game.loser; 
    });
    const losingPlayer = players[loserIndex];
    players[loserIndex] = { name: losingPlayer.name, won: losingPlayer.won, lost: losingPlayer.lost + 1};
